...
export default class About extends Component {
    render() {
        return (
            ...
            <p><span>
            Denna applikation skapades av mig, Emma Källström, då jag
            ...
            bara att ta kontakt med mig. Ett formulär finner du på Kontakt-sidan.
            </span></p>
            <p className="footer"><span>
            I denna applikation har jag använt mig dels utav Livsmedelsverkets databas (version 2017-12-15),
            men även Finelis för att komplettera Livsmedelsverkets version.
            </span></p>
            </div>
            </div>
            </div>
